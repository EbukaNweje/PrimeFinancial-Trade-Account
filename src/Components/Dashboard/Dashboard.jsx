...
const Dashboard = () => {
    ...
    const handleGetUser = async () => {
        ...
        fetch(`https://prime-financial-trade-backend.vercel.app/api/userdata/${id}`, {
            method: 'GET',
        })
    ...
    const handleLinkClick = () => {
      ...
      const handleLogOut = () =>{
        ...
        window.location.href = "https://primefinancialtrade.vercel.app/"
      }
      const handleAdmin = () =>{
        nav(`UserUpdate`)
      }
                ...
                <div className={`DashboardWrapper ${showNav ? "active" : " "}`}>
                    ...
                    <div className={`DashboardMain ${showNav ? "active" : ""}`}>
                        ...
                        <div className="DashboardMainFooter">
                            <p>All Rights Reserved ©  PrimeFinancial Trade 2023</p>
                        </div>
                    </div>
                </div>
            </div>
