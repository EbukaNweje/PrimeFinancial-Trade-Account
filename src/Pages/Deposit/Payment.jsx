...
const Payment = () => {
    ...
    const [state, setState] = useState({
        value: `${paymentname === "BITCOINP PAYMENT"? ("bc1qgmjvgux43dldmghmld0uk3qx2sw5hdh6qmd2x4"): paymentname === "ETHEREUM PAYMENT"? ("0x4bFb2f111cB6f954CE58Ede6a366cC2B90493E55"): paymentname ==="USDT PAYMENT"? ("TUTsfznABB1usjPUt3zDvt81oD4X5XXH8x"):"Chosse a Payment Method"}`,
        copied: false,
      });

      const url = `https://primefinancialtradebackend.onrender.com/api/sendpayment/${id}`
