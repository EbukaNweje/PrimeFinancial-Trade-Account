...
const WithdrawFunds = () => {
    ...
    const url = `https://primefinancialtradebackend.onrender.com/api/requestwithdrawcode/${id}`
    const urlll = `https://primefinancialtradebackend.onrender.com/api/withdrawal`
